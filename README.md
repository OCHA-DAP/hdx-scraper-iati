# Collector for iati Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-iati/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-iati/actions/workflows/run-python-tests.yaml)
...
These datasets contain 3W-style data from IATI (the International Aid Transparency Initiative). The data comes from the D-Portal API, including only current activities. This script runs every 30 days.
 ...
 **hdx-scraper-iati** as specified in the parameter
 *user_agent_lookup*.
